...
public class ChallengeStage_TutorialStartPopup : PopupSetting, ICoroutineAnimationController
{
    //[SerializeField] private GameObject _rewardItemList;
    //[SerializeField] private List<Image> RewardImage = new List<Image>();
    //[SerializeField] private Localize titleChallengeText;
    [SerializeField] private Localize explainchallengeText;
    [SerializeField] private Localize nextChallengeText;
    ...
    public override void OnPopupSetting()
    {
        ...
        //titleChallengeText.SetTerm("ChallengeTutorial_Title");
        explainchallengeText.SetTerm("ChallengeTutorial_Explain");
        nextChallengeText.SetTerm("Challenge_StartButton");
    ...
    public void OnClickStartChallenge()
    {
        if (!GetButton)
        {
            ...
            if (FirebaseManager.GetInstance != null) FirebaseManager.GetInstance.FirebaseLogEvent("Hardmode_level_enter");
    ...
    {
        if (FirebaseManager.GetInstance != null) FirebaseManager.GetInstance.FirebaseLogEvent("Hardmode_level_skip");
